...
namespace ThunderstoreCLI
{
    public static class Write
    {
        ...
        public static void Error(string message, params string[] submessages) => _WriteMultiline(_Error, $"ERROR: {message}", submessages);
        ...
        public static void Light(string message, params string[] submessages) => _WriteMultiline(_Light, message, submessages);
        ...
        public static void Note(string message, params string[] submessages) => _WriteMultiline(_Warn, message, submessages);

        /// <summary>Write success message to stdout</summary>
        public static void Success(string message, params string[] submessages) => _WriteMultiline(_Success, message, submessages);

        /// <summary>Write warning message to stdout</summary>
        public static void Warn(string message, params string[] submessages) => _WriteMultiline(_Warn, $"WARNING: {message}", submessages);
